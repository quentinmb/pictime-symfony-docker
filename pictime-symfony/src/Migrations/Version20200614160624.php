 ...
 */
final class Version20200614160624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BDAFD8C83124B5B6 ON author (lastname)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_BDAFD8C83124B5B6 ON author');
    }
}
